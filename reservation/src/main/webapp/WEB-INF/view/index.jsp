...
<div class="super_container">
	...
	<header class="header">
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			...
			<div class="ml-auto d-flex flex-row align-items-center justify-content-start">
				...
				<div class="book_button"><a href="/booking">Book Online</a></div>
	...
	<div class="home">
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slide -->
				<div class="slide">
					<div class="background_image" style="background-image:url(/resources/images/index_1.jpg)"></div>
							...
							<div class="row">
								<div class="col">
									<div class="home_content text-center">
										...
										<%-- <form:form method="POST" commandName="booi"> --%>
											<form action="/customerbooking" class="booking_form" id="home-user-booking" method="post">
												<div class="d-flex flex-xl-row flex-column align-items-start justify-content-start">
													<div class="booking_input_container d-flex flex-lg-row flex-column align-items-start justify-content-start">
														<div><input name="checkIn" id="checkIn" type="text" class="datepicker booking_input booking_input_a booking_in" placeholder="Check in" required="required"></div>
														<div><input name="checkOut" id="checkOut" type="text" class="datepicker booking_input booking_input_a booking_out" placeholder="Check out" required="required"></div>
														<div><input name="numberOfChildren" id="numberOfChildren" type="number" class="booking_input booking_input_b" placeholder="Children" required="required"></div>
														<div><input name="numberOfRoom" id="numberOfRoom" type="number" class="booking_input booking_input_b" placeholder="Room" required="required"></div>
													</div>
													<div><button type="submit" id="bookingBtn" class="booking_button trans_200">Book Now</button></div>
													<span id="bookingResult"></span>
												</div>
											</form>
											<%-- </form:form> --%>
										</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box d-flex flex-column align-items-center justify-content-start text-center">
						<div class="icon_box_icon"><img src="/resources/images/icon_1.svg" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box d-flex flex-column align-items-center justify-content-start text-center">
						<div class="icon_box_icon"><img src="/resources/images/icon_2.svg" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box d-flex flex-column align-items-center justify-content-start text-center">
						<div class="icon_box_icon"><img src="/resources/images/icon_3.svg" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
		...
		<div class="gallery_slider_container">
			<div class="owl-carousel owl-theme gallery_slider">
				...
				<div class="gallery_item">
					<div class="background_image" style="background-image:url(/resources/images/gallery_1.jpg)"></div>
					<a class="colorbox" href="/resources/images/gallery_1.jpg"></a>
				</div>

				<!-- Slide -->
				<div class="gallery_item">
					<div class="background_image" style="background-image:url(/resources/images/gallery_2.jpg)"></div>
					<a class="colorbox" href="/resources/images/gallery_2.jpg"></a>
				</div>

				<!-- Slide -->
				<div class="gallery_item">
					<div class="background_image" style="background-image:url(/resources/images/gallery_3.jpg)"></div>
					<a class="colorbox" href="/resources/images/gallery_3.jpg"></a>
				</div>

				<!-- Slide -->
				<div class="gallery_item">
					<div class="background_image" style="background-image:url(/resources/images/gallery_4.jpg)"></div>
					<a class="colorbox" href="/resources/images/gallery_4.jpg"></a>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="about_images d-flex flex-row align-items-center justify-content-between flex-wrap">
						<img src="/resources/images/about_1.png" alt="">
						<img src="/resources/images/about_2.png" alt="">
						<img src="/resources/images/about_3.png" alt="">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="testimonials">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="/resources/images/testimonials.jpg" data-speed="0.8"></div>
					...
					<div class="testimonials_slider_container">
						...
						<div class="owl-carousel owl-theme test_slider">
							...
							<div  class="test_slider_item text-center">
								...
								<div class="testimonial_image"><img src="/resources/images/user_1.jpg" alt=""></div>
							...
							<div  class="test_slider_item text-center">
								...
								<div class="testimonial_image"><img src="/resources/images/user_2.jpg" alt=""></div>
							...
							<div  class="test_slider_item text-center">
								...
								<div class="testimonial_image"><img src="/resources/images/user_3.jpg" alt=""></div>
					...
					<div class="booking_slider_container">
						<div class="owl-carousel owl-theme booking_slider">
							...
							<div class="booking_item">
								<div class="background_image" style="background-image:url(/resources/images/booking_1.jpg)"></div>
								<div class="booking_overlay trans_200"></div>
								<div class="booking_price">$120/Night</div>
								<div class="booking_link"><a href="booking.jsp">Family Room</a></div>
							</div>

							<!-- Slide -->
							<div class="booking_item">
								<div class="background_image" style="background-image:url(/resources/images/booking_2.jpg)"></div>
								<div class="booking_overlay trans_200"></div>
								<div class="booking_price">$120/Night</div>
								<div class="booking_link"><a href="booking.jsp">Deluxe Room</a></div>
							</div>

							<!-- Slide -->
							<div class="booking_item">
								<div class="background_image" style="background-image:url(/resources/images/booking_3.jpg)"></div>
								<div class="booking_overlay trans_200"></div>
								<div class="booking_price">$120/Night</div>
								<div class="booking_link"><a href="booking.jsp">Single Room</a></div>
							</div>
		...
		<div class="blog_slider_container">
			<div class="owl-carousel owl-theme blog_slider">
				...
				<div class="blog_slide">
					<div class="background_image" style="background-image:url(/resources/images/index_blog_1.jpg)"></div>
				...
				<!-- Slide -->
				<div class="blog_slide">
					<div class="background_image" style="background-image:url(/resources/images/index_blog_2.jpg)"></div>
					<div class="blog_content">
						<div class="blog_date"><a href="#">Oct 20, 2018</a></div>
				...
				<!-- Slide -->
				<div class="blog_slide">
					<div class="background_image" style="background-image:url(/resources/images/index_blog_3.jpg)"></div>
					<div class="blog_content">
						<div class="blog_date"><a href="#">Oct 20, 2018</a></div>
				...
				<div class="row footer_row">
					...
					<div class="col-lg-3">
						<div class="certificates d-flex flex-row align-items-start justify-content-lg-between justify-content-start flex-lg-nowrap flex-wrap">
							<div class="cert"><img src="/resources/images/cert_1.png" alt=""></div>
							<div class="cert"><img src="/resources/images/cert_2.png" alt=""></div>
						</div>
					</div>
				</div>
			</div>
