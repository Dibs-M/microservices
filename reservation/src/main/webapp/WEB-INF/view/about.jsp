...
<div class="super_container">
	...
	<div class="home">
		<div class="background_image" style="background-image:url(/resources/images/about.jpg)"></div>
			...
			<div class="row about_row">
				...
				<div class="col-lg-6">
					<div class="about_content">
						...
						<div class="about_sig"><img src="/resources/images/sig.png" alt=""></div>
					</div>
				</div>
			...
			<div class="row row-xl-eq-height">
				...
				<div class="col-xl-6 order-xl-1 order-2">
					<div class="split_section_image">
						<div class="background_image" style="background-image:url(/resources/images/milestones.jpg)"></div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-xl-6">
					<div class="split_section_image split_section_left_image">
						<div class="background_image" style="background-image:url(/resources/images/loaders.jpg)"></div>
					</div>
				</div>
